    ...
    <div className="bg-muted py-4">
      <div className="container-custom">
        <nav className="flex items-center gap-2 text-sm">
          ...
          <Link href="/products" className="text-gray-500 hover:text-primary">Shop</Link>
          <span className="text-gray-400">/</span>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {product.benefits.map((benefit, i) => (
            <span key={i} className="px-4 py-2 bg-muted rounded-full font-medium">
              {benefit}
            </span>
          ))}
        </div>
          ...
          {activeTab === 0 && (
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-sm text-gray-500 mb-4">Per serving (500ml)</p>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between py-2 border-b">
                    <span>Fiber</span>
                    <span className="font-semibold">{product.nutritionalInfo.fiber}g</span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span>Vitamin C</span>
                    <span className="font-semibold">{product.nutritionalInfo.vitaminC}%</span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span>Vitamin A</span>
                    <span className="font-semibold">{product.nutritionalInfo.vitaminA}%</span>
                  </div>
                </div>
              </div>
      ...
      <div className="container-custom">
        <div className="bg-white/10 backdrop-blur rounded-2xl p-8 text-center">
          ...
          <p className="text-lg mb-6 max-w-xl mx-auto">
            Save 20% when you subscribe. Get fresh juices delivered to your door on your schedule.
